            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title">Org Non Gov</h4>
                  ...
                  <div class="col-md-12 grid-margin">
                    <div class="card">
                      <div class="card-body">
						...
						<div class="row mt-3 mb-3">
                          <div class="col-lg-4"> Do you want Authorised signatory DSC</div>
                          <div class="col-lg-8">
                            <div class="form-check-inline">
                             <input type="radio" name="radio" id="radio3"><label class="form-check-label" for="radio3">Yes</label>
                            </div>
                          <div class="form-check-inline">
                           <input type="radio" name="radio" id="radio4"><label class="form-check-label" for="radio4">No</label>
						  </div>
						  <div class="mt-3 mb-3">
						  <a href="last.html" class="btn-genrate" type="submit">Set Passcode</a> <a href="last.html" class="btn-genrate" type="submit">Verify</a>
						  </div>
                          </div>
						</div>
						<div class="row mt-3 mb-3">
                          <div class="col-lg-4"> Set Passcode</div>
                          <div class="col-lg-4">
                            <input type="text" class="form-control" placeholder="123456">
                          </div>
						  <div class="col-lg-4">
                            <a href="last.html" class="btn-form" type="submit">Confirm</a>
                          </div>
						...
						<div class="row mt-3 mb-3">
                          ...
                          <div class="col-lg-4">
                            <a href="last.html" class="btn-genrate" type="submit">Download Passcode</a>
                          </div>
						...
						<div class="row mt-3 mb-3">
                          <div class="col-lg-4"> 
						  <div class="form-check-inline">
                             <input type="checkbox" name="radio" id="radio3">&nbsp; <label class="form-check-label" for="radio3">Signing</label>
                            </div>
						  </div>
                          <div class="col-lg-4">
              ...
              <div class="mt-3 col-12">
                <div class="row">
                  ...
                  <div class="col-md-12 grid-margin">
                    <div class="card">
                      <div class="card-body">
						Your Request ID is <b>1231231</b>
                        <div class="row mt-3 mb-3">
                          <div class="col-lg-12">
                            Applicant KYC ID is <b>1231231</b>
                          </div>
						</div>
					
						<div class="row mt-3 mb-3">
                          <div class="col-lg-12"> Authorized Signatory Ekyc ID is <b>937123893</b> </div>
                        </div>
						<div class="d-flex mt-3 mb-3 justify-content-left">
						<a href="" class="btn-form" type="submit">Edit Info</a>
                        </div>
                        </div>
                  ...
                  <div class="col-md-12 grid-margin">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row mt-3 mb-3">
                          <div class="col-lg-12">
                            Esign Application form and Esign Subscribe aggreement
                          </div>
						</div>
					
						<div class="row mt-3 mb-3">
                          <div class="col-lg-3"> <a href="" class="btn-genrate" type="submit">Generate OTP</a>  </div>
						  <div class="col-lg-5"> <input type="tel" class="form-control" placeholder="OTP"></div>
						  <div class="col-lg-3"> <a href="" class="btn-form" type="submit">Skip</a> </div>
                        </div>
						<div class="row mt-3 mb-3">
                          <div class="col-lg-3"> <a href="" class="btn-genrate" type="submit">Record Video</a>  </div>
						  <div class="col-lg-3"> <a href="" class="btn-form" type="submit">Skip</a> </div>
                        </div>
						<div class="row mt-3 mb-3">
                          <div class="col-lg-12">
						  Status of Mail verfication Pending / Done
						  </div>
						</div>
                        </div>
			  ...
			  <div class="col-md-12 grid-margin">
                    <div class="card">
                      <div class="card-body">
						...
						<div class="row mt-3 mb-3">
						  <div class="col-lg-2">Esign</div>
                          <div class="col-lg-3"> <a href="" class="btn-genrate" type="submit">Generate OTP</a>  </div>
						  <div class="col-lg-5"> <input type="tel" class="form-control" placeholder="OTP"></div>
						  <div class="col-lg-2"> <a href="" class="btn-form" type="submit">Skip</a> </div>
                        </div>
						<div class="row mt-3 mb-3">
						<div class="col-lg-2">Video verfication</div>
                          <div class="col-lg-3"> <a href="" class="btn-genrate" type="submit">Record Video</a>  </div>
						  <div class="col-lg-3"> <a href="" class="btn-form" type="submit">Skip</a> </div>
                        </div>
						<div class="row mt-3 mb-3">
