          ...
          <div class="content-wrapper">
            ...
            <div class="row mt-3">
             <div class="col-lg-12 border"> 
                  <div class="org-div"><h4 class="org-heading"><i class="fa fa-university" aria-hidden="true"></i> Org DGST Gov </h4></div>
				   <div class="row">
                ...
                <option value="">Select</option>
						...
						<div class="row mt-3 mb-3">
                          <div class="col-lg-4"> DGFTIEC </div>
                          <div class="col-lg-8">
                            <input type="text" class="form-control" name="dgftiec" placeholder="yousecure accounting">
                          </div>
                        </div>
						<div class="row mt-3 mb-3">
                          <div class="col-lg-4">DGFT Code </div>
                          <div class="col-lg-8">
                            <input type="text" class="form-control" name="dgftcode" placeholder="yousecure">
                          </div>
                        </div>
                        <div class="row mt-3 mb-3">
                                      <div class="col-lg-4"> Branch Code </div>
                                      <div class="col-lg-8">
                                        <input type="text" class="form-control" name="branchcode" placeholder="Address">
                                      </div>
                                    </div>
            <div class="row mt-3 mb-3">
               ...
               <div class="col-md-6 grid-margin">
                    ...
                    <div class="card same mt-3 mb-3 auth-sig">
                      <div class="card-body">
                     <h2> <a href="{{route('saurav.orggovdgst')}}">&#8249;</a> </h2>
						...
						<div class="row mt-3 mb-3">
                          ...
                          <div class="col-lg-4">
                            {{-- <a href="" class="btn-genrate" type="submit">Generate OTP</a>  --}}
                          </div>
                        </div>
						<div class="row mt-3 mb-3">
						{{-- <div class="col-lg-4"> Enter OTP </div> --}}
