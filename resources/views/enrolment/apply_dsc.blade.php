        ...
        <section>
          <div class="form">
            {{-- <form > --}}
              ...
              <hr/>
              <h5 class="pb-4">Application Type</h5>
              <div class="mb-4">
                <div class="form-check-inline">
                  <input type="radio" name="type" id="radio1" value="Ind"><label class="form-check-label" for="radio1">Ind</label>
                </div>
                <div class="form-check-inline">
                  <input type="radio" name="type" id="radio2" disabled><label class="form-check-label" for="radio2">Org</label>
                </div>
                <div class="form-check-inline">
                  <input type="radio" name="type" id="radio3" disabled><label class="form-check-label" for="radio3">Govt</label>
                </div>
                <div class="form-check-inline">
                  <input type="radio" name="type" id="radio4" disabled><label class="form-check-label" for="radio4">Doc Signer</label>
                </div>
                <div class="form-check-inline">
                  <input type="radio" name="type" id="radio5" disabled><label class="form-check-label" for="radio5">Foregin</label>
                </div>
                <p id="type_error"></p>
              </div>
              <div class="text-right">
                <!---<button class="btn-form" type="submit">Next</button>-->
                {{-- <a href="form1.html" class="btn-form">Next</a> --}}
                <button type="button" class="btn-form" id="move_step2">Next</button>
              </div>
            {{-- </form> --}}
          </div>
        <section>
          ...
          <div class="form">
            {{-- <form> --}}
              ...
              <div class="mb-4">
                ...
                {{-- <div class="row mb-3">
                  <div class="col-lg-4">Existing Ekyc holder</div>
                  <div class="col-lg-8">
                    <div class="form-check-inline">
                      <input type="radio" name="holder" id="kyc_holder1" value="Yes" /><label
                    ...
                    <div class="form-check-inline">
                      <input type="radio" name="holder" id="kyc_holder2" value="No" /><label
                        class="form-check-label"
                        for="kyc_holder2"
                        >No
                      </label>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-lg-8">
                    {{-- <div class="form-check-inline">
                      <input type="radio" name="ekyc_type" id="kyc_type1" /><label
                        class="form-check-label"
                        for="kyc_type1"
                        >Aadhar
                      </label>
