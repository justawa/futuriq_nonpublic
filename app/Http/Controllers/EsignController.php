...
class EsignController extends Controller
{
    ...
    public function sendXml()
    {
        ...
        $tcpdf = new \Elibyy\TCPDF\TCPDF($pdf_settings['page_orientation'], $pdf_settings['page_units'], $pdf_settings['page_format'], true, 'UTF-8', false);

        // // set document information
        // $tcpdf->SetCreator($pdf_settings['creator']);
        // $tcpdf->SetAuthor('Nicola Asuni');
        // $tcpdf->SetTitle('TCPDF Example 052');
        // $tcpdf->SetSubject('TCPDF Tutorial');
        // $tcpdf->SetKeywords('TCPDF, PDF, example, test, guide');

        // // set default header data
        // $tcpdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, PDF_HEADER_TITLE.' 052', PDF_HEADER_STRING);
        ...
        // set document signature
        $tcpdf->setSignature($resp_docsignature3, $resp_docsignature3, 'tcpdfdemo', '', 2, $info);
        ...
        // $tcpdf->Image('../images/tcpdf_signature.png', 180, 60, 15, 15, 'PNG');
        ...
        $pdfdoc = $tcpdf->Output('doc_sign.pdf', 'I');
        ...
        // // save pdf file
        // $pdfdoc = TCPDF::Output(public_path('esign.pdf'), 'F');
    ...
    {
        $response = $this->client->request('POST', '14.98.56.14:9080', [
            'json'    => ['requestBody' => [
                ...
                "csr"=> "",
                "transactionId" => "Ogwt4bXwlFcxyJu8Zj4SghP4YxsJeJcW"
                ],
                "signature" =>	""
            ],
        ]);
